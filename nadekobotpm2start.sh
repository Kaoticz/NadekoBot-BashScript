...
if [ $choice -eq 1 ] ; then
	echo ""
	wget -N https://github.com/Kaoticz/NadekoBot-BashScript/raw/1.9k/NadekoARN.sh 
	cd "$root"
	...
	if [ $choice -eq 2 ] ; then
		echo ""
		wget -N https://github.com/Kaoticz/NadekoBot-BashScript/raw/1.9k/NadekoARU_Latest.sh 
		cd "$root"
		...
		if [ $choice -eq 3 ] ; then
		echo ""
		wget -N https://github.com/Kaoticz/NadekoBot-BashScript/raw/1.9k/nadeko_run.sh
		cd "$root"
